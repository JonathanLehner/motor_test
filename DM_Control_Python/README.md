...
macOS helper scripts for reading/writing motor IDs and running one-motor movement tests are documented in [README_MACOS_SCRIPTS.md](README_MACOS_SCRIPTS.md).
